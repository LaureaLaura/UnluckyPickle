...
/**
 * La classe Parser è responsabile dell'analisi delle stringhe di input per identificare comandi e oggetti.
 */
public class Parser {
     ...
     *
     * @param paroleInutili Un set di parole inutili da non considerare durante l'analisi delle stringhe di input.
     */
     ...
     * @param tokenInput Il token di input da cercare tra i nomi dei comandi e i loro alias.
     ...
     * @return L'indice dell'oggetto trovato nella lista o -1 se non è stato trovuto.
     */
     ...
     * @return Un oggetto OutputParser contenente le informazioni analizzate dalla frase di input.
     */    
