...
/**
 * Questa classe rappresenta un oggetto contenitore all'interno del gioco. Gli oggetti contenitori sono
 * oggetti speciali in grado di contenere altri oggetti. Sono una sottoclasse della classe `Oggetti`.
 */
public class OggettoContenitore extends Oggetti { 
    ...
    /**
     * Costruttore per un oggetto contenitore con identificatore, nome e descrizione.
     *
     * @param id L'identificatore unico dell'oggetto contenitore.
     * @param name Il nome dell'oggetto contenitore.
    ...
    /**
     * Costruttore per un oggetto contenitore con identificatore, nome, descrizione e alias.
     *
     * @param id L'identificatore unico dell'oggetto contenitore.
     * @param name Il nome dell'oggetto contenitore.
     * @param description La descrizione dell'oggetto contenitore.
    ...
    /**
     * Aggiunge un oggetto alla lista di oggetti contenuti all'interno del contenitore.
     *
    ...
    /**
     * Rimuove un oggetto dalla lista di oggetti contenuti all'interno del contenitore.
     *
