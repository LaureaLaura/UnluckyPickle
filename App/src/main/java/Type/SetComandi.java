...
/**
 * Questa classe rappresenta un insieme di comandi utilizzati nel gioco. Ogni
 * comando è associato a un nome,
 * un tipo di comando (enum `Comandi`), e un insieme di alias che possono essere
 * utilizzati per riconoscere il comando.
 */
